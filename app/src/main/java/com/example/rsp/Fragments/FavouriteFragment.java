...
import com.example.rsp.ui.Adds.FavouriteViewHolder;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions options =
                new FirebaseRecyclerOptions.Builder<Post>()
                        ...
                        .build();
        FirebaseRecyclerAdapter<Post, FavouriteViewHolder> firebaseRecyclerOptions =
                new FirebaseRecyclerAdapter<Post, FavouriteViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull final FavouriteViewHolder holder, int position, @NonNull Post model) {
                    ...
                    public FavouriteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_favourite_list, parent, false);
                        FavouriteViewHolder nabila = new FavouriteViewHolder(view);
                        return nabila;
                    }
                };
